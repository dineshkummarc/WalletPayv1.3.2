import { StyleSheet, Dimensions, View, Text, BackHandler, Pressable, ScrollView } from "react-native";
...
const PaymentView = (props) => {
    ...
    const handleMessage = (event) => {
        ...
        if (typeof status === 'string' && status.toLowerCase() == 'coinpayment-success') {
            ...
            {code == 201 && (
                <View style={styles.bottomCont}>
                    <Text style={styles.bottomText}>
                        {trans('This screen automatically redirect to home after') + ' ' + (leaveTile / 1000) + 's'}
                    </Text>
                </View>
            )}
        </>
